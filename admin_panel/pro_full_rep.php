...
<?php include 'header.php'; // Storing session in var and got This session from login.php page
...
if (empty($_GET['id'])) {
	# code...
	$General->redirect_to('reported.php');
}

$sql = mysql_query("SELECT * FROM `products` INNER JOIN `report` ON `products`.`id` = '$id'");
...
<!--*******************************************************************************************-->
			...
			<br>
			<br>
			<label><b>Reported By:</b>&nbsp;&nbsp; <?php echo $rep_name;?>(<?php echo $rep_email;?>)</label>
			<br>
			<br>
			<label><b>Reported Messege:</b>&nbsp;&nbsp; <?php echo $rep_msg;?></label>
			<br>
			<br>
