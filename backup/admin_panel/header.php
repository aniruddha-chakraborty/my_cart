...
<div class="nav-outer"> 
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo">Categories List</a></li>
				<li><a href="#nogo">Edit Categories</a></li>
				<li><a href="#nogo">Delete Categories</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo">Clints Level 1</a></li>
				<li><a href="#nogo">Clients Level 2</a></li>
				<li><a href="#nogo">Clients Level 3</a></li>
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo">News About the Site</a></li>
				<li><a href="#nogo">Messege From Client</a></li>
				<li><a href="#nogo">Messege From buyer</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
